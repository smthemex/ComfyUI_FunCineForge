...
def main(args):
    ...
    #args = ap.parse_args()
    root_dir, workers, max_outstanding, lang, min_audio_sec_for_text_check, min_cjk_chars, min_ascii_chars, execute, delete_log=args.root, args.workers, args.max_outstanding, args.lang, args.min_audio_sec, args.min_cjk_chars, args.min_ascii_chars, args.execute, args.delete_log
