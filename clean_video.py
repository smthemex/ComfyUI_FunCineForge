...
def main(args):
    ...
    root_dir, min_sec, max_sec, workers, max_outstanding, execute, log_path=args.root, args.min_sec, args.max_sec, args.workers, args.max_outstanding, args.execute, args.log
