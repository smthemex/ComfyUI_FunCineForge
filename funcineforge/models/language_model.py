...
from .utils.llm_decoding import LLMDecoder
...
class FunCineForgeLM(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.llm = None
        #print(1111,llm_conf.keys()) #dict_keys(['hub', 'freeze', 'llm_dtype', 'init_param_path', 'use_lora', 'lora_conf'])
    ...
    def load_data(self, contents: dict, **kwargs):
        ...
        # timespk_ids
        timespk_ids = contents["timespk_ids"]
        if hasattr(timespk_ids, 'tolist'):
            timespk_ids = timespk_ids.tolist()
    ...
    def inference_prepare(self, data_in, **kwargs):
        ...
        #print(face_embs.shape,face_embs.dtype) #torch.Size([1, 156, 512]) torch.float32
        #print(codec_embs.dtype, timespk_embeds.dtype) #torch.bfloat16 torch.bfloat16
        #print(text_embeds.dtype) #torch.bfloat16 torch.bfloat16
